---
name: process-source-corpus
description: Use when processing a source PDF into reusable notes, references, and explanation views in this repository
---

# Process Source Corpus
...
```bash
uv run ledger process /path/to/DAR-I-087.pdf
```
