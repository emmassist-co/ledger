...
Run evals from the archive repo itself:
...
RUN_ARCHIVE_EVALS_WRAPPER = """from __future__ import annotations

import sys

from ledger.evals.archive_evals import main
...
SCAFFOLD_ARCHIVE_EVALS_WRAPPER = """from __future__ import annotations

import sys

from ledger.evals.scaffold_archive_evals import main
...
def scaffold_archive_evals_workspace(root: Path, include_wrappers: bool = True) -> None:
    ...
    if include_wrappers:
        write_text(root / "scripts" / "run_archive_evals.py", RUN_ARCHIVE_EVALS_WRAPPER)
        write_text(root / "scripts" / "scaffold_archive_evals.py", SCAFFOLD_ARCHIVE_EVALS_WRAPPER)
