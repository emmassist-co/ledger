...
<body>
  <div class="app">
    <aside class="sidebar">
      <p class="sidebar-kicker">Ledger Dossier</p>
      <h1 class="sidebar-title" id="doc-title">Ledger Explorer</h1>
  ...
  <script id="__LEDGER_DATA__" type="application/json">{data_json}</script>
  <script>
    const data = JSON.parse(document.getElementById('__LEDGER_DATA__').textContent);
